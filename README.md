...
for the bounding box.Then the bounding box starting point is calculated according to
# (x1,y1)=(left,top
and the ending point of the bounding box is 
...
Credits to 
# Marco Giordano
for sharing his code. Some slight modifications have taken place on the code to account for Face Detection
